...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#ebdbb2' # fg
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#83a598' # dark blue
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|minikube|skaffold'
